defmodule Aoc23Test.P04 do
  ...
  # @tag :focus
  # @tag :pending
  describe "P04 part one (...)" do
    test "test input" do
      assert 13 == Aoc23.P04.run(Aoc23.P04.test_file())
    end

    test "real input" do
      assert 21558 == Aoc23.P04.run(Aoc23.P04.input_file())
    end
  end

  describe "P0X part two (...)" do
    test "test input" do
      assert 30 == Aoc23.P04.run2(Aoc23.P04.test_file())
    end
